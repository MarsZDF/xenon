...
def repair_xml_safe(
    ...
    Args:
        ...
        auto_wrap_cdata: Automatically wrap code-like content in CDATA sections.
                        ...
                        Prevents double-escaping of special characters in code snippets.
        format_output: Output formatting style - 'pretty', 'compact', 'minify', or None (v0.6.0)
        html_entities: HTML entity handling - 'numeric', 'unicode', or None (v0.6.0)
        normalize_unicode: Apply Unicode NFC normalization (v0.6.0)
    ...
    Examples:
        ...
        >>> repair_xml_safe(b'<root>test</root>')  # v0.6.0: bytes input
        '<root>test</root>'

        >>> repair_xml_safe('<root>', format_output='pretty')  # v0.6.0: formatting
        '<root></root>'

        >>> repair_xml_safe('<p>&euro;50</p>', html_entities='numeric')  # v0.6.0
        '<p>&#8364;50</p>'
    """
